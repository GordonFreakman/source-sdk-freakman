...
{
	//CBasePlayer *pOwner = ToBasePlayer(player);
	...
	//if (player->m_Local.m_bHasLongJump) {};
	MoveHelper()->StartSound(mv->GetAbsOrigin(), "Player.Jump"); //Jump Noise
	...
	OnJump(mv->m_outJumpVel.z); // I think this makes the player jump

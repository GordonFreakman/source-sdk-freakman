...
#ifndef WEAPON_8BITCROWBAR_H
#define WEAPON_8BITCROWBAR_H
...
class CWeapon8BitCrowbar : public CBaseHLBludgeonWeapon
{
public:
	DECLARE_CLASS(CWeapon8BitCrowbar, CBaseHLBludgeonWeapon);

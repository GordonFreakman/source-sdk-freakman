...
class CWeaponShotgunScope : public CBaseHLCombatWeapon
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS(CWeaponShotgunScope, CBaseHLCombatWeapon);
...
public:
	...
	CWeaponShotgunScope(void);
};

IMPLEMENT_SERVERCLASS_ST(CWeaponShotgunScope, DT_WeaponShotgunScope)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_shotgun_scope, CWeaponShotgunScope);
PRECACHE_WEAPON_REGISTER(weapon_shotgun_scope);

BEGIN_DATADESC(CWeaponShotgunScope)
...
acttable_t	CWeaponShotgunScope::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponShotgunScope);

void CWeaponShotgunScope::Precache(void)
{
...
// Input  : *pOperator - 
//-----------------------------------------------------------------------------
void CWeaponShotgunScope::FireNPCPrimaryAttack(CBaseCombatCharacter *pOperator, bool bUseWeaponAngles)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponShotgunScope::Operator_ForceNPCFire(CBaseCombatCharacter *pOperator, bool bSecondary)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgunScope::Operator_HandleAnimEvent(animevent_t *pEvent, CBaseCombatCharacter *pOperator)
{
	switch (pEvent->event)
	{
...
//-----------------------------------------------------------------------------
float CWeaponShotgunScope::GetMinRestTime()
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
float CWeaponShotgunScope::GetMaxRestTime()
{
	if (hl2_episodic.GetBool() && GetOwner() && GetOwner()->Classify() == CLASS_COMBINE)
	{
		return 1.5f;
...
//-----------------------------------------------------------------------------
float CWeaponShotgunScope::GetFireRate()
{
	if (hl2_episodic.GetBool() && GetOwner() && GetOwner()->Classify() == CLASS_COMBINE)
	{
		return 0.8f;
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponShotgunScope::StartReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
bool CWeaponShotgunScope::Reload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgunScope::FinishReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgunScope::FillClip(void)
{
	CBaseCombatCharacter *pOwner = GetOwner();
...
// Output :
//-----------------------------------------------------------------------------
void CWeaponShotgunScope::Pump(void)
{
	CBaseCombatCharacter *pOwner = GetOwner();
...
//
//-----------------------------------------------------------------------------
void CWeaponShotgunScope::DryFire(void)
{
	WeaponSound(EMPTY);
...
//
//-----------------------------------------------------------------------------
void CWeaponShotgunScope::PrimaryAttack(void)
{
	...
	pPlayer->FireBullets(8, vecSrc, vecAiming, vec3_origin, MAX_TRACE_LENGTH, m_iPrimaryAmmoType, 0);
...
//-----------------------------------------------------------------------------
// Purpose: Actually Im going to give it a fucking scope.
//
//
//-----------------------------------------------------------------------------
/*
void CWeaponShotgunScope::SecondaryAttack(void)
{
	// Only the player fires this way so we can cast
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
void CWeaponShotgunScope::SecondaryAttack(void)
{
	// Ok, This should enable the scope.
}

void CWeaponShotgunScope::CheckZoomToggle(void)
{
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
//-----------------------------------------------------------------------------
void CWeaponShotgunScope::ItemPostFrame(void)
{
...
void CWeaponShotgunScope::ToggleZoom(void)
{
	CBasePlayer *pPlayer = ToBasePlayer(GetOwner());
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CWeaponShotgunScope::CWeaponShotgunScope(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponShotgunScope::ItemHolsterFrame(void)
{
	// Must be player held

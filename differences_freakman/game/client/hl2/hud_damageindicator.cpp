...
private:
	...
	CPanelAnimationVar( Color, m_DmgColorLeft, "DmgColorLeft", "0 255 0 0" );
	CPanelAnimationVar( Color, m_DmgColorRight, "DmgColorRight", "0 255 0 0" );

	CPanelAnimationVar( Color, m_DmgHighColorLeft, "DmgHighColorLeft", "0 255 0 0" );
	CPanelAnimationVar( Color, m_DmgHighColorRight, "DmgHighColorRight", "0 255 0 0" );

	CPanelAnimationVar( Color, m_DmgFullscreenColor, "DmgFullscreenColor", "0 255 0 0" );

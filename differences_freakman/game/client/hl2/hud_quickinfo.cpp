...
void CHUDQuickInfo::Paint()
{
	...
	// Good Stuff
	Color goodColor = Color(RandomFloat(0, 255), RandomFloat(0, 255), RandomFloat(0, 255), 255);

	// Update our health
	if ( m_healthFade > 0.0f )
	{
		//DrawWarning( xCenter - (m_icon_lb->Width() * 2), yCenter, m_icon_lb, m_healthFade );
		DrawWarning(xCenter - m_icon_lb->Width(), yCenter, m_icon_lb, m_healthFade);
	}
	else
	{
		...
		//gHUD.DrawIconProgressBar(xCenter - (m_icon_lb->Width() * 2), yCenter, m_icon_lb, m_icon_lbe, (1.0f - RandomFloat(0.0f,healthPerc)), healthColor, CHud::HUDPB_VERTICAL);
		//gHUD.DrawIconProgressBar(xCenter - (m_icon_lb->Width() * 2), yCenter, m_icon_lb, m_icon_lbe, (RandomFloat(0.0f, 1.0f - healthPerc)), healthColor, CHud::HUDPB_VERTICAL);
		//gHUD.DrawIconProgressBar(xCenter - (m_icon_lb->Width() * 2), yCenter, m_icon_lb, m_icon_lbe, (RandomFloat(0.0f, 1.0f - healthPerc)), goodColor, CHud::HUDPB_VERTICAL);
		gHUD.DrawIconProgressBar(xCenter - m_icon_lb->Width(), yCenter, m_icon_lb, m_icon_lbe, (RandomFloat(0.0f, 1.0f - healthPerc)), goodColor, CHud::HUDPB_VERTICAL);
		//gHUD.DrawIconProgressBar(xCenter - m_icon_lb->Width() - 8, yCenter, m_icon_lb, m_icon_lbe, (RandomFloat(0.0f, 1.0f - healthPerc)), goodColor, CHud::HUDPB_VERTICAL);
	}
	...
	if ( m_ammoFade > 0.0f )
	{
		...
		DrawWarning(xCenter, yCenter, m_icon_rb, m_ammoFade);
	}
	else
	{
		float ammoPerc;
		...
		//gHUD.DrawIconProgressBar(xCenter + m_icon_rb->Width(), yCenter, m_icon_rb, m_icon_rbe, RandomFloat(0.0f,ammoPerc), ammoColor, CHud::HUDPB_VERTICAL);
		//gHUD.DrawIconProgressBar(xCenter + m_icon_rb->Width(), yCenter, m_icon_rb, m_icon_rbe, RandomFloat(0.0f, ammoPerc), goodColor, CHud::HUDPB_VERTICAL);
		gHUD.DrawIconProgressBar(xCenter, yCenter, m_icon_rb, m_icon_rbe, RandomFloat(0.0f, ammoPerc), goodColor, CHud::HUDPB_VERTICAL);
		//gHUD.DrawIconProgressBar(xCenter + 8, yCenter, m_icon_rb, m_icon_rbe, RandomFloat(0.0f, ammoPerc), goodColor, CHud::HUDPB_VERTICAL);
	}
}

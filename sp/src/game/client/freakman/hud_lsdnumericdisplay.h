...
#ifndef HUD_LSDNUMERICDISPLAY_H
#define HUD_LSDNUMERICDISPLAY_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class CHudLSDNumericDisplay : public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CHudLSDNumericDisplay, vgui::Panel );

public:
	CHudLSDNumericDisplay(vgui::Panel *parent, const char *name);

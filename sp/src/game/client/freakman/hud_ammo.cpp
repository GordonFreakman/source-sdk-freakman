...
//-----------------------------------------------------------------------------
class CHudAmmo : public CHudLSDNumericDisplay, public CHudElement
{
	DECLARE_CLASS_SIMPLE(CHudAmmo, CHudLSDNumericDisplay);
...
{
	m_icon_ammo = gHUD.GetIcon("ammo_label");
}
...
void CHudAmmo::Paint( void )
{
	...
	if ( m_hCurrentVehicle == NULL && m_iconPrimaryAmmo )
	{
		...
		m_icon_ammo->DrawSelf(text_xpos, text_ypos, GetFgColor());
	}
#endif // HL2MP
}
...
//-----------------------------------------------------------------------------
class CHudSecondaryAmmo : public CHudLSDNumericDisplay, public CHudElement
{
	DECLARE_CLASS_SIMPLE(CHudSecondaryAmmo, CHudLSDNumericDisplay);

...
STUB_WEAPON_CLASS( weapon_missingpaste, WeaponMissingPaste, C_BaseHLCombatWeapon);
...
STUB_WEAPON_CLASS( weapon_antlion, WeaponAntlion, C_BaseCombatWeapon);
...
STUB_WEAPON_CLASS( weapon_shotgun_scope, WeaponShotgunScope, C_BaseHLCombatWeapon);
...
STUB_WEAPON_CLASS( weapon_physgun, CWeaponGravityGun, C_BaseHLCombatWeapon);
STUB_WEAPON_CLASS( weapon_crowbar, WeaponCrowbar, C_BaseHLBludgeonWeapon );
STUB_WEAPON_CLASS( weapon_bent_crowbar, WeaponBCrowbar, C_BaseHLBludgeonWeapon );
STUB_WEAPON_CLASS( weapon_8bit_crowbar, Weapon8BitCrowbar, C_BaseHLBludgeonWeapon );
STUB_WEAPON_CLASS( weapon_dual_crowbar, WeaponDualCrowbar, C_BaseHLBludgeonWeapon);
STUB_WEAPON_CLASS( weapon_wand, WeaponWand, C_BaseHLBludgeonWeapon);

#ifdef HL2_EPISODIC
STUB_WEAPON_CLASS( weapon_hopwire, WeaponHopwire, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_proto1, WeaponProto1, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_tamp, WeaponTamp, C_BaseHLBludgeonWeapon);
#endif
#ifdef HL2_LOSTCOAST
